...
from app.api.v1.endpoints import auth, community, friends, squads, rides, safety, media, friends_match
...
api_router.include_router(friends_match.router, prefix="/friends", tags=["Friends Match"])
